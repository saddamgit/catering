  ...
  <div class="container-fluid ">
    <div class="menu">
       ...
       <ul class="nav navbar-nav">
          ...
          <li><a href="paket.php" id="active">Paket</a></li>
...
<!--batas nav -->
   ...
   <div class="container" style="width:700px;">  
                   <h2 align="center" style="color: white;background: #be1630;padding: 10px;border-radius: 20px;">Pilih Paket Anda !!!</h2><br/>  
                <?php  
                $query = "SELECT * FROM tb_produk WHERE jenis = 'paket' ORDER BY idProduk ASC";  
                ...
                <div class="col-md-4" style="margin-bottom: 50px">  
                     <form method="post" action="cartProduk.php">  
                          <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">  
                               ...
                               <input type="number" name="quantity" class="form-control" value="1" style="width: 100px"/>
